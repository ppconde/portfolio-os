...
export default function WebsiteHome() {
  return (
    <section className="flex h-full w-full flex-col items-center justify-center overflow-hidden bg-dots bg-[length:20px_20px] bg-[0_0_10px_10px] bg-repeat">
      <header className="p-4 text-center text-gray-900">
      ...
      <NavList className="flex w-full flex-col items-center justify-center text-xl sm:flex-row" />
    </section>
  );
}
