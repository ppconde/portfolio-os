/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c108629b73c77bf318adf2806d19cb3c)
// Runtime types generated with workerd@1.20251011.0 2025-11-03 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/workers/app");
	}
	interface Env {
		PORTFOLIO_OS_KV: KVNamespace;
		GITHUB_KEY: string;
		PORTFOLIO_OS_SECRETS: SecretsStoreSecret;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_KEY">> {}
}
